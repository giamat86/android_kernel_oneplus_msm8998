...
// Gesture flags
int DouTap_gesture = BIT1; /* double tap */
int DownVee_gesture = BIT2; /* V */
int UpVee_gesture = BIT3; /* ^ */
int LeftVee_gesture = BIT4; /* > */
int RightVee_gesture = BIT5; /* < */
int Circle_gesture = BIT6; /* O */
int DouSwip_gesture = BIT7; /* || */
int Left2RightSwip_gesture = BIT8;/* --> */
int Right2LeftSwip_gesture = BIT9;/* <-- */
int Up2DownSwip_gesture = BITA;/* |v */
int Down2UpSwip_gesture = BITB;/* |^ */
int Wgestrue_gesture = BITC;/* W */
int Mgestrue_gesture = BITD;/* M */
int Sgestrue_gesture = BITE;/* S */
...
static ssize_t key_switch_write_func(struct file *file, const char __user *buffer, size_t count, logg_t *ppos)
{
    char buf[4] = {0};
    int ret;
    struct synaptics_ts_data *ts = ts_g;
